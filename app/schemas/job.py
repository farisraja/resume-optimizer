...
class ParsedJobDescription(BaseModel):
    company: str = Field(..., title="Name of the company or 'Unknown' if not found")
    role: str = Field(..., title="Role or job title")
    description: str = Field(..., title="Full text of the job description from the image")
